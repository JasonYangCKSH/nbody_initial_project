...
function App() {
  ...
  return <main className="app-shell">
    ...
    <aside className="panel"><header><div><span className="eyebrow">COLLISION LAB / PHASE 01</span><h1>Broad-phase<br /><em>diagnostics</em></h1></div><Activity size={22} color="#5DCAA5" /></header>
      ...
      <div className="control-block phase-block"><div className="block-heading">PHASE TIMING <span>03</span></div><div className="phase-chart-title mint">BROAD-PHASE</div><PhaseChart history={history} metricKey="broadPhaseMs" color="#5DCAA5" label="broad-phase" markRebuilds={bufferEnabled} /><div className="phase-chart-title gold">NARROW-PHASE</div><PhaseChart history={history} metricKey="narrowPhaseMs" color="#D9A441" label="narrow-phase" /></div>
